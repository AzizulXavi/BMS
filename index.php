...
<body>
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <p class="text-center">Welcome to Simple Bus Management System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                    We are a dedicated team of professionals passionate about simplifying and streamlining the process of managing bus transportation.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        BUS MANAGEMENT SYSTEM FOR GUB PROJECT IDP II
                        </p>
        </footer>
    </div>
